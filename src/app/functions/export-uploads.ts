...
export async function exportUploads(input: ExportUploadsInput): Promise<Either<never, ExportUploadsOutput>> {
    ...
    // CURSOR = Retornar os dados de pouco em pouco | Por default retorna 1 por vez
    const cursor = pg.unsafe(sql, params as string[]).cursor(50) // aqui estou colocando 50 por vez
